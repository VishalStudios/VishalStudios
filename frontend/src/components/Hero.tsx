    ...
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden bg-dark-900">
      ...
      <div className="relative z-10 text-center text-white px-6 md:px-12 w-full mt-20">
        ...
        <button
          ...
          className="absolute bottom-4 left-1/2 transform -translate-x-1/2 animate-bounce flex flex-col items-center gap-2 opacity-50 hover:opacity-100 transition-opacity duration-300 md:bottom-5"
        >
